...
#include "objects/shapefactory.h"
...
//                SDL_GetMouseState(&posX, &posY);
//                Vec2 pos(posX, posY);
//                pegs.push_back(shapeFactory->createPeg(pos,3));
//            }
//        }
//
    bool rectLeftClick(SDL_MouseButtonEvent& b) {
            ...
            if(!boxPointASelected) {
                ...
                rectangles.push_back(shapeFactory->createRectangle(boxPosX, boxPosY, width, height));
...
//                        Vec2 pos(posX, posY);
//
//                        circles.push_back(shapeFactory->createCircle(pos, vel, random,true));
//                    }
//                }
//
...
//                Vec2 pos(posX, posY);
//
//                circles.push_back(shapeFactory->createCircle(pos, vel, random,false));
//            }
//        }
    ...
    void GeneratePachinko() {
        ...
        for(int x = 0; x < WIDTH; x += 50) {
            rectangles.push_back(shapeFactory->createRectangle(x, HEIGHT-300, 10, 300));
        }
    }
    ...
    void buttonClicked(int type, Simulation sim)
    {
        ...
        else if (type ==2)
        {
            ...
            circles.push_back(shapeFactory->createCircle(pos, vel, random));
        }
        else if (type ==3)
        {
            int random = rand()%3+3;
    ...
    void EventHandler() {
        ...
        while (SDL_PollEvent(&e)){
            ...
            //     eventHappened = windows[i]->handleButtonClick(e);
