...
Circle::Circle(Vec2 pos, Vec2 vel, double m, SDL_Color col) 
...
Circle::Circle(Vec2 pos, Vec2 vel, double m, SDL_Color col, bool attractOrRepulse)
    : Object(pos, vel, m, col) {
        radius = m * 3;
        diameter = 2 * radius;
...
void Circle::DrawVelocity(SDL_Renderer* renderer) {
...
void Circle::LineBounce(Vec2 normal) {
    Vec2 tmp;
...
void Circle::CollisionEdges(int width, int height) {
...
void Circle::WrapAround(int WIDTH, int HEIGHT) {
...
void Circle::CollisionBoundaries(vector<Boundary*> boundaries) {
...
void Circle::CollisionBoundary(Boundary boundary) {
...
void Circle::CollisionCircles(vector<Circle*> circles) {
...
void Circle::CollisionPegs(vector<Peg*> pegs) {
...
void Circle::CollisionRectangles(vector<Rectangle*> rectangles) {
...
void Circle::ResolveCollisionPeg(Peg* peg) {
...
void Circle::ResolveCollisionCircle(Circle* circle) {
...
double Circle::Constrain(double a, double b, double c)
{
    if (a<b)
        return b;
    else if(a > c)
...
/* F = (G(m1 * m2)/r^2) * r hat */
void Circle::Attract(Circle* circ)
{
...
void Circle::Friction(int height)
{
